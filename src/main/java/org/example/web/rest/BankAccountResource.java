...
/**
 * REST controller for managing {@link org.example.domain.BankAccount}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<BankAccount> partialUpdateBankAccount(
        ...
        Optional<BankAccount> result = bankAccountRepository
            ...
            .map(existingBankAccount -> {
                ...
                if (bankAccount.getAddressLine() != null) {
                    existingBankAccount.setAddressLine(bankAccount.getAddressLine());
                }
                ...
                if (bankAccount.getSwift() != null) {
                    existingBankAccount.setSwift(bankAccount.getSwift());
                }
                if (bankAccount.getCorrespondentName() != null) {
                    existingBankAccount.setCorrespondentName(bankAccount.getCorrespondentName());
                }
                if (bankAccount.getCorrespondentAddress() != null) {
                    existingBankAccount.setCorrespondentAddress(bankAccount.getCorrespondentAddress());
                }
                if (bankAccount.getCorrespondentSwift() != null) {
                    existingBankAccount.setCorrespondentSwift(bankAccount.getCorrespondentSwift());
                }

...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="generatingInvoiceApp.address.delete.question">
        <Translate contentKey="generatingInvoiceApp.address.delete.question" interpolate={{ id: addressEntity.id }}>

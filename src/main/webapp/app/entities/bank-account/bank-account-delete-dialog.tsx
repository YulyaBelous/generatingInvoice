...
export const BankAccountDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="generatingInvoiceApp.bankAccount.delete.question">
        <Translate contentKey="generatingInvoiceApp.bankAccount.delete.question" interpolate={{ id: bankAccountEntity.id }}>

...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="generatingInvoiceApp.customer.delete.question">
        <Translate contentKey="generatingInvoiceApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>

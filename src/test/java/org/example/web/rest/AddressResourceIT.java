...
class AddressResourceIT {
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getPhone1()).isEqualTo(DEFAULT_PHONE_1);
        assertThat(testAddress.getPhone2()).isEqualTo(DEFAULT_PHONE_2);
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        assertThat(testAddress.getPhone1()).isEqualTo(UPDATED_PHONE_1);
        assertThat(testAddress.getPhone2()).isEqualTo(UPDATED_PHONE_2);
    }

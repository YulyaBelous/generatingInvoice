...
class CustomerResourceIT {
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).shortName(UPDATED_SHORT_NAME).fullName(UPDATED_FULL_NAME).taxCode(UPDATED_TAX_CODE);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).shortName(UPDATED_SHORT_NAME).fullName(UPDATED_FULL_NAME).taxCode(UPDATED_TAX_CODE);
